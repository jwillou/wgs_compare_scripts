...
print(summary(lm(genS_K80~perrange, data=data[data$perrange>0,])))
...
print(summary(lm(mtW_K80~perrange, data=data[data$perrange>0,])))
...
print(summary(lm(hyb~perrange, data=data, family="binomial")))
...
print(summary(lm(hyb~rdist_km, data=data, family="binomial")))
dev.off()
sink()
